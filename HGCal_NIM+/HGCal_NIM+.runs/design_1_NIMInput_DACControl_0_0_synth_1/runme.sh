...
HD_PWD='C:/Users/songw/Dropbox/NIM+/Projects/HGCal_NIM+/HGCal_NIM+.runs/design_1_NIMInput_DACControl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_NIMInput_DACControl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_NIMInput_DACControl_0_0.tcl
