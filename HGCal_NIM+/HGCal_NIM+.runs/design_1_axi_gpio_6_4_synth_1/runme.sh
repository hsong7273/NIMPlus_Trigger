...
HD_PWD='C:/NIM+/HGCal_NIM+/HGCal_NIM+.runs/design_1_axi_gpio_6_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_6_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_6_4.tcl
