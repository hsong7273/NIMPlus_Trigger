...
HD_PWD='C:/NIM+/HGCal_NIM+/HGCal_NIM+.runs/design_1_PulseCounter_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PulseCounter_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PulseCounter_2_0.tcl
