...
HD_PWD='C:/Users/advlab/Desktop/MBAA/HGCal_NIM+/HGCal_NIM+.runs/design_1_PulseCounter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PulseCounter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PulseCounter_0_0.tcl
