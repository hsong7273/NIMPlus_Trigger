...
-- Date        : Wed Sep  1 21:27:16 2021
-- Host        : DESKTOP-LE7HFDS running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/NIM+/HGCal_NIM+/HGCal_NIM+.srcs/sources_1/bd/design_1/ip/design_1_join_truth_tables_0_1/design_1_join_truth_tables_0_1_sim_netlist.vhdl
...
entity design_1_join_truth_tables_0_1 is
  ...
  attribute NotValidForBitStream of design_1_join_truth_tables_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_join_truth_tables_0_1 : entity is "design_1_join_truth_tables_0_1,join_truth_tables,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_join_truth_tables_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_join_truth_tables_0_1 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of design_1_join_truth_tables_0_1 : entity is "join_truth_tables,Vivado 2019.1";
end design_1_join_truth_tables_0_1;

architecture STRUCTURE of design_1_join_truth_tables_0_1 is
