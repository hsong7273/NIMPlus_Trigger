...
set_property -dict { PACKAGE_PIN Y11 IOSTANDARD LVCMOS33 } [get_ports sigout1];  # "JA1"
set_property -dict { PACKAGE_PIN Y10 IOSTANDARD LVCMOS33 } [get_ports sigout2];  # "JA3"
set_property -dict { PACKAGE_PIN AB11 IOSTANDARD LVCMOS33 } [get_ports sigout3];  # "JA7"
# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
...
set_property -dict { PACKAGE_PIN N20 IOSTANDARD LVDS_25} [get_ports {FMC_LA01_CC_N}];  # "FMC-LA01_CC_N"
set_property -dict { PACKAGE_PIN N19 IOSTANDARD LVDS_25} [get_ports {FMC_LA01_CC_P}];  # "FMC-LA01_CC_P" - corrected 6/6/16 GE
set_property -dict { PACKAGE_PIN P18 IOSTANDARD LVDS_25} [get_ports {FMC_LA02_N}];  # "FMC-LA02_N"
set_property -dict { PACKAGE_PIN P17 IOSTANDARD LVDS_25} [get_ports {FMC_LA02_P}];  # "FMC-LA02_P"
set_property -dict { PACKAGE_PIN P22 IOSTANDARD LVDS_25} [get_ports {FMC_LA03_N}];  # "FMC-LA03_N"
set_property -dict { PACKAGE_PIN N22 IOSTANDARD LVDS_25} [get_ports {FMC_LA03_P}];  # "FMC-LA03_P"
...
set_property -dict { PACKAGE_PIN L22 IOSTANDARD LVDS_25} [get_ports {FMC_LA06_N}];  # "FMC-LA06_N"
set_property -dict { PACKAGE_PIN L21 IOSTANDARD LVDS_25} [get_ports {FMC_LA06_P}];  # "FMC-LA06_P"
set_property -dict { PACKAGE_PIN T17 IOSTANDARD LVDS_25} [get_ports {FMC_LA07_N}];  # "FMC-LA07_N"
set_property -dict { PACKAGE_PIN T16 IOSTANDARD LVDS_25} [get_ports {FMC_LA07_P}];  # "FMC-LA07_P"
set_property -dict { PACKAGE_PIN J22 IOSTANDARD LVDS_25} [get_ports {FMC_LA08_N}];  # "FMC-LA08_N"
set_property -dict { PACKAGE_PIN J21 IOSTANDARD LVDS_25} [get_ports {FMC_LA08_P}];  # "FMC-LA08_P"
set_property -dict { PACKAGE_PIN R21 IOSTANDARD LVDS_25} [get_ports {FMC_LA09_N}];  # "FMC-LA09_N"
set_property -dict { PACKAGE_PIN R20 IOSTANDARD LVDS_25} [get_ports {FMC_LA09_P}];  # "FMC-LA09_P"
...
set_property -dict { PACKAGE_PIN P21 IOSTANDARD LVDS_25} [get_ports {FMC_LA12_N}];  # "FMC-LA12_N"
set_property -dict { PACKAGE_PIN P20 IOSTANDARD LVDS_25} [get_ports {FMC_LA12_P}];  # "FMC-LA12_P"
set_property -dict { PACKAGE_PIN M17 IOSTANDARD LVDS_25} [get_ports {FMC_LA13_N}];  # "FMC-LA13_N"
set_property -dict { PACKAGE_PIN L17 IOSTANDARD LVDS_25} [get_ports {FMC_LA13_P}];  # "FMC-LA13_P"
set_property -dict { PACKAGE_PIN K20 IOSTANDARD LVDS_25} [get_ports {FMC_LA14_N}];  # "FMC-LA14_N"
set_property -dict { PACKAGE_PIN K19 IOSTANDARD LVDS_25} [get_ports {FMC_LA14_P}];  # "FMC-LA14_P"
set_property -dict { PACKAGE_PIN J17 IOSTANDARD LVDS_25} [get_ports {FMC_LA15_N}];  # "FMC-LA15_N"
set_property -dict { PACKAGE_PIN J16 IOSTANDARD LVDS_25} [get_ports {FMC_LA15_P}];  # "FMC-LA15_P"
set_property -dict { PACKAGE_PIN K21 IOSTANDARD LVDS_25} [get_ports {FMC_LA16_N}];  # "FMC-LA16_N"
set_property -dict { PACKAGE_PIN J20 IOSTANDARD LVDS_25} [get_ports {FMC_LA16_P}];  # "FMC-LA16_P"
...
set_property -dict { PACKAGE_PIN G16 IOSTANDARD LVCMOS25} [get_ports {FMC_LA19_N}];  # "FMC-LA19_N"
set_property -dict { PACKAGE_PIN G15 IOSTANDARD LVCMOS25} [get_ports {FMC_LA19_P}];  # "FMC-LA19_P"
set_property -dict { PACKAGE_PIN G21 IOSTANDARD LVCMOS25} [get_ports {FMC_LA20_N}];  # "FMC-LA20_N"
set_property -dict { PACKAGE_PIN G20 IOSTANDARD LVCMOS25} [get_ports {FMC_LA20_P}];  # "FMC-LA20_P"
#set_property -dict { PACKAGE_PIN E20 IOSTANDARD LVCMOS25} [get_ports {FMC_LA21_N}];  # "FMC-LA21_N"
#set_property -dict { PACKAGE_PIN E19 IOSTANDARD LVCMOS25} [get_ports {FMC_LA21_P}];  # "FMC-LA21_P"
set_property -dict { PACKAGE_PIN F19 IOSTANDARD LVCMOS25} [get_ports {FMC_LA22_N}];  # "FMC-LA22_N"
set_property -dict { PACKAGE_PIN G19 IOSTANDARD LVCMOS25} [get_ports {FMC_LA22_P}];  # "FMC-LA22_P"
